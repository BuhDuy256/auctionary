...
### `products`
(`product_id`, `category_id`, `seller_id`, `highest_bidder_id`, `name`, `thumbnail_url`, `current_price`, `buy_now_price`, `start_price`, `step_price`, `start_time`, `end_time`, `bid_count`, `auto_extend`, `status`, `fts`)
