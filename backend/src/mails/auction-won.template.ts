// src/mails/auction-won.template.ts

import { themes } from "../configs/themes.config";

interface AuctionWonTemplateProps {
  userName: string;
  productName: string;
  productImage?: string;
...
export const getAuctionWonTemplate = ({
  userName,
  productName,
  productImage,
  finalBidAmount,
  productUrl,
}: AuctionWonTemplateProps): string => {
  ...
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: ${
          ...
          <tr>
            <td style="padding: 0 40px;">
              ...
              <p style="color: ${
                ...
                You are the winner of the auction for <strong style="color: ${
                  colors.textMain
                };">${productName}</strong>. Please proceed to complete your order.
              </p>
    ...
    colors.statusSuccess
                    ...
                    <p style="color: ${
                      ...
                      Please complete the payment process to finalize your purchase. The seller will then prepare your order for delivery.
                    </p>
                  </td>
                </tr>
              </table>
