// src/mails/new-question.template.ts

import { themes } from "../configs/themes.config";

interface NewQuestionTemplateProps {
  sellerName: string;
  productName: string;
  productImage?: string;
  question: string;
  askedBy: string; // Masked buyer name
  productUrl: string;
}

export const getNewQuestionTemplate = ({
  sellerName,
  productName,
  productImage,
  question,
  askedBy,
  productUrl,
}: NewQuestionTemplateProps): string => {
...
<head>
  ...
  <title>New Question About Your Product</title>
</head>
  ...
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: ${
          ...
          <tr>
            <td style="padding: 0 40px;">
              ...
              <p style="color: ${
                ...
                A buyer has asked a question about your product <strong style="color: ${
                  colors.textMain
                };">${productName}</strong>.
              </p>
                    ...
                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="padding-bottom: 10px;">
                          <span style="color: ${
                            colors.textMuted
                          }; font-size: 14px;">Asked by:</span>
                          <span style="color: ${
                            colors.textMain
                          }; font-size: 14px; font-weight: 600; margin-left: 5px;">${askedBy}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-top: 10px; border-top: 1px solid ${
                          ...
                          <p style="color: ${
                            colors.textMain
                          }; font-size: 15px; line-height: 1.6; margin: 0; font-style: italic;">
                            "${question}"
                          </p>
                        </td>
                      </tr>
    ...
    colors.statusInfo
                    ...
                    <p style="color: ${
                      ...
                      <strong>Tip:</strong> Responding quickly to buyer questions can increase interest and help you get better bids!
                    </p>
                  </td>
                </tr>
              </table>
    ...
    colors.textInverse
              ...
              <p style="color: ${
                ...
                Click the button above to view your product and respond to the buyer.
              </p>
            </td>
          </tr>
