...
<head>
  ...
  <title>Welcome to Auctionary!</title>
</head>
<body style="margin: 0; padding: 0; background-color: ${
  ...
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: ${
    ...
    colors.border
          ...
          <tr>
            <td style="background-color: ${colors.textMain}; height: 4px;"></td>
          </tr>
          ...
          <tr>
            <td style="padding: 0 40px;">
              ...
              <p style="color: ${
                ...
                We are thrilled to have you join our community. Your account has been successfully verified, and you're now ready to start bidding and selling!
              </p>
    ...
    colors.accent
                    ...
                    <p style="color: ${
                      ...
                      Explore our auctions, place your first bid, or list an item for sale. The possibilities are endless!
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" style="padding: 30px 0;">
                    <a href="${homeUrl}" style="background-color: ${
    colors.accent
  }; color: ${
    colors.textInverse
