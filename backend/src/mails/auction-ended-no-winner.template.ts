// src/mails/auction-ended-no-winner.template.ts

import { themes } from "../configs/themes.config";

interface AuctionEndedNoWinnerTemplateProps {
  sellerName: string;
  productName: string;
  productImage?: string;
  startPrice: number;
...
export const getAuctionEndedNoWinnerTemplate = ({
  sellerName,
  productName,
  productImage,
  startPrice,
  endDate,
  dashboardUrl,
}: AuctionEndedNoWinnerTemplateProps): string => {
  ...
  const formattedPrice = startPrice.toLocaleString("en-US", {
    style: "currency",
    currency: "USD",
  });
...
<head>
  ...
  <title>Auction Ended - No Bids Received</title>
</head>
  ...
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: ${
          ...
          <tr>
            <td style="padding: 0 40px;">
              ...
              <p style="color: ${
                ...
                Your auction for <strong style="color: ${
                  colors.textMain
                };">${productName}</strong> has ended. Unfortunately, no bids were received during the auction period.
              </p>
                          ...
                          <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td style="width: 50%;">
                                <span style="color: ${
                                  colors.textMuted
                                }; font-size: 14px;">Starting Price:</span>
                              </td>
                              <td style="width: 50%; text-align: right;">
                                <span style="color: ${
                                  colors.textMain
                                }; font-size: 16px; font-weight: 600;">${formattedPrice}</span>
                              </td>
                            </tr>
                          </table>
                        </td>
                          ...
                          <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td style="width: 50%;">
                                <span style="color: ${
                                  colors.textMuted
                                }; font-size: 14px;">End Date:</span>
                              </td>
                              <td style="width: 50%; text-align: right;">
                                <span style="color: ${
                                  colors.textMain
                                }; font-size: 16px; font-weight: 600;">${endDate}</span>
                              </td>
                            </tr>
                          </table>
                        </td>
                          ...
                          <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td style="width: 50%;">
                                <span style="color: ${
                                  colors.textMuted
                                }; font-size: 14px;">Total Bids:</span>
                              </td>
                              <td style="width: 50%; text-align: right;">
                                <span style="color: ${
                                  colors.statusInfo
                                }; font-size: 16px; font-weight: 600;">0</span>
                              </td>
                            </tr>
                          </table>
                        </td>
    ...
    colors.statusInfo
                    ...
                    <p style="color: ${
                      ...
                      You may want to consider relisting this item with adjusted pricing or better product descriptions to attract more bidders.
                    </p>
                  </td>
                </tr>
              </table>
    ...
    colors.textInverse
              ...
              <p style="color: ${
                ...
                Thank you for using Auctionary. We hope to see your products again soon!
              </p>
            </td>
          </tr>
