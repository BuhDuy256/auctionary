// src/mails/seller-answered.template.ts

import { themes } from "../configs/themes.config";

interface SellerAnsweredTemplateProps {
  userName: string;
  productName: string;
  productImage?: string;
  question: string;
...
export const getSellerAnsweredTemplate = ({
  userName,
  productName,
  productImage,
  question,
  answer,
  productUrl,
}: SellerAnsweredTemplateProps): string => {
...
<head>
  ...
  <title>Seller Has Answered a Question</title>
</head>
  ...
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: ${
          ...
          <tr>
            <td style="padding: 0 40px;">
              ...
              <p style="color: ${
                ...
                💬 Seller Has Answered a Question
              </p>
              <p style="color: ${
                colors.textMuted
              }; font-size: 16px; line-height: 1.6; margin-bottom: 30px;">
                The seller has posted an answer about <strong style="color: ${
                  colors.textMain
                };">${productName}</strong>.
              </p>
                    ...
                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="padding-bottom: 15px;">
                          <span style="color: ${
                            colors.textMuted
                          }; font-size: 13px; text-transform: uppercase; font-weight: 600;">Question:</span>
                          <p style="color: ${
                            colors.textMain
                          }; font-size: 15px; line-height: 1.6; margin: 8px 0 0 0; font-style: italic;">
                            "${question}"
                          </p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-top: 15px; border-top: 1px solid ${
                          ...
                          <span style="color: ${
                            colors.accent
                          }; font-size: 13px; text-transform: uppercase; font-weight: 600;">Answer:</span>
                          <p style="color: ${
                            colors.textMain
                          }; font-size: 15px; line-height: 1.6; margin: 8px 0 0 0;">
                            ${answer}
                          </p>
                        </td>
                      </tr>
    ...
    colors.textInverse
              ...
              <p style="color: ${
                ...
                Check out the full product details and Q&A section for more information.
              </p>
            </td>
          </tr>
