// src/mails/outbid-notification.template.ts

import { themes } from "../configs/themes.config";

interface OutbidNotificationTemplateProps {
  userName: string;
  productName: string;
  productImage?: string;
...
export const getOutbidNotificationTemplate = ({
  userName,
  productName,
  productImage,
  currentBidAmount,
  productUrl,
}: OutbidNotificationTemplateProps): string => {
  ...
  const formattedAmount = currentBidAmount.toLocaleString("en-US", {
    style: "currency",
    currency: "USD",
  });
  ...
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: ${
          ...
          <tr>
            <td style="padding: 0 40px;">
              ...
              <p style="color: ${
                ...
                Someone has placed a higher bid on <strong style="color: ${
                  colors.textMain
                };">${productName}</strong>. Don't lose your chance to win!
              </p>
                    ...
                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="padding-bottom: 10px;">
                          <span style="color: ${
                            colors.textMuted
                          }; font-size: 14px;">Current Highest Bid:</span>
                        </td>
                      </tr>
                      <tr>
    ...
    colors.textInverse
              ...
              <p style="color: ${
                ...
                Act fast! The auction could end at any time.
              </p>
            </td>
          </tr>
