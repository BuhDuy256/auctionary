// src/mails/bid-placed.template.ts

import { themes } from "../configs/themes.config";

interface BidPlacedTemplateProps {
  userName: string;
  productName: string;
  productImage?: string;
  bidAmount: number;
...
export const getBidPlacedTemplate = ({
  userName,
  productName,
  productImage,
  bidAmount,
  ...
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: ${
          ...
          <tr>
            <td style="padding: 0 40px;">
              ...
              <p style="color: ${
                ...
                Your bid for <strong style="color: ${
                  colors.textMain
                };">${productName}</strong> has been confirmed.
              </p>
                    ...
                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="padding-bottom: 10px;">
                          <span style="color: ${
                            colors.textMuted
                          }; font-size: 14px;">Your Bid Amount:</span>
                        </td>
                      </tr>
                      <tr>
    ...
    colors.textInverse
              ...
              <p style="color: ${
                ...
                ${
                  currentHighestBidder
                    ? "Keep an eye on your auction! You'll be notified if someone outbids you."
                    : "Want to stay in the lead? Place a higher bid now!"
                }
              </p>
            </td>
          </tr>
